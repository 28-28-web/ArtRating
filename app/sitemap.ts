...
const routes: { path: string; priority: number; changeFrequency: MetadataRoute.Sitemap[number]["changeFrequency"] }[] = [
  ...
  { path: "/photo-to-coloring-page", priority: 0.8, changeFrequency: "monthly" },
  { path: "/ai-coloring-book-generator", priority: 0.8, changeFrequency: "monthly" },
  { path: "/free-ai-coloring-page-generator", priority: 0.8, changeFrequency: "monthly" },
